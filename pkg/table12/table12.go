...
func New(start, end uint16) *Table12 {
	return &Table12{
...
func (r *Table12) Get(id uint16) (tree.Entry, error) {
...
func (r *Table12) Claim(id uint16, labels labels.Set) error {
	// Validate input
	if err := r.validateID(id); err != nil {
		return err
	}
...
func (r *Table12) ClaimFree(labels labels.Set) (tree.Entry, error) {
	// Validate input
...
func (r *Table12) Release(id uint16) error {
	// Validate input
	if err := r.validateID(id); err != nil {
		return err
	}
...
func (r *Table12) Update(id uint16, labels labels.Set) error {
	// Validate input
	if err := r.validateID(id); err != nil {
		return err
	}
...
func (r *Table12) Size() int {
	return r.table.Size()
}

func (r *Table12) Has(id uint16) bool {
	// Validate IP address
	if err := r.validateID(id); err != nil {
		return false
	}
...
func (r *Table12) IsFree(id uint16) bool {
	// Validate IP address
	if err := r.validateID(id); err != nil {
		return false
	}
...
func (r *Table12) FindFree() (uint16, error) {
...
func (r *Table12) GetAll() tree.Entries {
...
func (r *Table12) GetByLabel(selector labels.Selector) tree.Entries {
	entries := make(tree.Entries, 0, r.table.Size())
...
func (r *Table12) validateID(id uint16) error {
